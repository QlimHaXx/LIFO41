...
unsigned int LoadGLTexture(const char* nomfichier, bool isTransparency, const unsigned char R, const unsigned char G, const unsigned char B, int option)
{
    Image image1;
    imInitPPM( image1, nomfichier);

    if (isTransparency) imCreateTransparency(image1, R,G,B, option);
